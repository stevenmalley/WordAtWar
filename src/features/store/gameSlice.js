...
export const gameSlice = createSlice({
  ...
  reducers: {
    ...
    clearQuizResults:(game,action) => {game.quizResults = null},
    setMessage:(game,action) => {game.message = action.payload},
    wipeGameData:(game,action) => nullGame,
  },
...
export const clearQuizResults = (placementScore) => {
  return (dispatch, getState) => {
    dispatch({type: 'game/clearQuizResults', payload: null});
  }
};

export const setMessage = (message) => {
  return (dispatch, getState) => {
    dispatch({type: 'game/setMessage', payload: message});
  }
};

export const wipeGameData = () => {
  return (dispatch, getState) => {
    dispatch({type: 'game/wipeGameData', payload: null});
  }
}